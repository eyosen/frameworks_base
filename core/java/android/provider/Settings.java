...
public final class Settings {
	 ...
	 * Indicates the state of DC dimming AUTO mode:
        ...
        */
        ...
        static {
            ...
            AICP_SETTINGS_VALIDATORS.put(ALERT_SLIDER_NOTIFICATIONS, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(STATUS_BAR_LOGO, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(MUTE_ANNOYING_NOTIFICATIONS_THRESHOLD, ANY_INTEGER_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(VOLUME_KEY_CURSOR_CONTROL, BOOLEAN_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(THREE_FINGER_GESTURE, BOOLEAN_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(AICP_ASPECT_RATIO_APPS_LIST, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(AICP_ASPECT_RATIO_APPS_ENABLED, BOOLEAN_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(SMART_PIXELS_ENABLE, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(ON_THE_GO_CAMERA, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(VOLTE_ICON_STYLE, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(VOWIFI_ICON_STYLE, ANY_INTEGER_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(POCKET_JUDGE, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(PULSE_AMBIENT_LIGHT_COLOR_MODE, ANY_INTEGER_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_LONG_PRESS_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_LONG_PRESS_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_LONG_PRESS_CUSTOM_APP_FR_NAME, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_DOUBLE_TAP_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_DOUBLE_TAP_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_HOME_DOUBLE_TAP_CUSTOM_APP_FR_NAME, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_MENU_LONG_PRESS_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_MENU_DOUBLE_TAP_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_LONG_PRESS_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_LONG_PRESS_CUSTOM_APP_FR_NAME, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_LONG_PRESS_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_DOUBLE_TAP_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_DOUBLE_TAP_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_BACK_DOUBLE_TAP_CUSTOM_APP_FR_NAME, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_ASSIST_LONG_PRESS_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_ASSIST_DOUBLE_TAP_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_APP_SWITCH_LONG_PRESS_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_APP_SWITCH_LONG_PRESS_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_APP_SWITCH_LONG_PRESS_CUSTOM_APP_FR_NAME, ANY_STRING_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_APP_SWITCH_DOUBLE_TAP_ACTION, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(KEY_APP_SWITCH_DOUBLE_TAP_CUSTOM_APP, ANY_INTEGER_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(SCREEN_STATE_THREEG, BOOLEAN_VALIDATOR);
            ...
            AICP_SETTINGS_VALIDATORS.put(STATUSBAR_LEFT_PADDING, ANY_INTEGER_VALIDATOR);
            AICP_SETTINGS_VALIDATORS.put(STATUSBAR_RIGHT_PADDING, ANY_INTEGER_VALIDATOR);
        }
    ...
    public static final class Global extends NameValueTable {
        ...
        */
        ...
        /**
         * AOKP Custom System Animations duration in milliseconds
         * @hide
         */
