...
public class KeyguardStatusView extends GridLayout implements
    ...
    private CustomTextClock mTextClockPreamble;
    private CustomTextClock mTextClockFirstLine;
    private CustomTextClock mTextClockSecondLine;
    ...
    protected void onFinishInflate() {
        ...
        mTextClockPreamble = findViewById(R.id.textView);
        mTextClockFirstLine = findViewById(R.id.custom_textclock_view1);
        mTextClockSecondLine = findViewById(R.id.custom_textclock_view2);
...
//        updateSettings();
    ...
    public void refreshclocksize() {
        ...
        mClockView.setTextSize(TypedValue.COMPLEX_UNIT_PX, DeviceUtils.convertDpToPixel(lockClockSize, getContext()));
        mTextClockPreamble.setTextSize(TypedValue.COMPLEX_UNIT_PX, DeviceUtils.convertDpToPixel(lockClockSize, getContext()));
        mTextClockFirstLine.setTextSize(TypedValue.COMPLEX_UNIT_PX, DeviceUtils.convertDpToPixel(lockClockSize, getContext()));
        mTextClockSecondLine.setTextSize(TypedValue.COMPLEX_UNIT_PX, DeviceUtils.convertDpToPixel(lockClockSize, getContext()));
    }
    ...
    public void refreshdatesize() {
        ...
        mKeyguardSlice.setViewsTextSize(TypedValue.COMPLEX_UNIT_SP, lockDateSize);
    }
