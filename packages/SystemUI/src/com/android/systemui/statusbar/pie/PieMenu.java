...
public class PieMenu extends RelativeLayout {
    ...
    protected void updateNotifications() {
        mNotificationData = mNotificationEntryManager.getNotificationData();
/*        mNotifications = mNotificationData.getNotificationsForCurrentUser();
                    ...
                    for (int i = 0; i < mIconViews.size(); i++) { // Use only 1 loop because the size is the same
                        ...
                        try {
                            ...
                            mNotificationEntryManager.performRemoveNotification(
                                    p.first, UNDEFINED_DISMISS_REASON);
